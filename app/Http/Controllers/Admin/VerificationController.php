...
class VerificationController extends Controller
{
    ...
    public function show($id)
    {
        ...
        ->with(['doc_req' => function ($query) {
            $query->select(['document_requirements.requirement_value', 'document_requirements.type', 'document_requirements.document_id', 'document_category_requirements.requirement_type'])

...
<div class="vertical-modal-ex">
    <!-- Modal -->
    <div class="modal fade" id="modal-docs-req" tabindex="-1" role="dialog" aria-labelledby="SubUnitModalTitle" aria-hidden="true">
                     ...
                     <div class="col-md-12">
                        ...
                        <form id="form-doc-req" name="form-doc-req" class="auth-register-form mt-2" >
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" id="requirement_value" name="requirement_value" placeholder="Nilai Keperluan" aria-label="requirement_value"  aria-describedby="requirement_value" />
                                </div>
                        </div>
                </div>

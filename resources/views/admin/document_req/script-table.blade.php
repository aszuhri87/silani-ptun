    ...
    var DocsReqTable = function() {
        ...
        const initTable = () => {
            init_table = $('#init-table').DataTable({
                ...
                ajax: {
                    type: 'POST',
                    url: "{{ url('admin/document-req/dt') }}",
                },
                columns: [
                    { data: 'DT_RowIndex' },
                    { data: 'document', "searchable": false},
                    { data: 'document_category_requirement', "searchable": false },
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render : function(data, type, full, meta) {
                            ...
                            <a href="{{ url('admin/document-req') }}/${data}" title="Edit" class="btn btn-light btn-edit btn-sm btn-clean btn-icon" title="Edit">
                                    ...
                                    <a href="{{ url('admin/document-req') }}/${data}" title="Delete" class="btn btn-light btn-delete btn-sm btn-clean btn-icon" title="Delete">
                                        <span class="svg-icon svg-icon-md">

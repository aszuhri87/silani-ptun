...
<div class="vertical-modal-ex">
    <!-- Modal -->
    <div class="modal fade" id="modal-list-applicant" tabindex="-1" role="dialog" aria-labelledby="SubUnitModalTitle"
        aria-hidden="true">
                        ...
                        <form id="form-list-applicant" name="form-list-applicant" class="auth-register-form mt-2">
                            ...
                            <div class="form-group">
                                <select class="form-control" name="title" id="title">
                                    ...
                                    <option value="Kasub Perencanaan, TI dan Pelaporan">Kasub Perencanaan, TI dan
                                        Pelaporan</option>
                                    ...
                                    <option value="Analis Perencanaan, Evaluasi, dan Pelaporan">Analis Perencanaan,
                                        Evaluasi, dan Pelaporan</option>
                                    ...
                                    <option value="Pengelola BMN, Sub Bag Umum dan KU">Pengelola BMN, Sub Bag Umum dan
                                        KU</option>
                                    <option value="Analis Perkara Peradilan">Analis Perkara Peradilan</option>
                                    <option value="Pengadministrasi Umum, Sub Bag Umum dan KU">Pengadministrasi Umum,
                                        Sub Bag Umum dan KU</option>
                            ...
                            <div class="input-group mb-1">
                                <input type="text" class="form-control" id="nip" name="nip"
                                    placeholder="nip" aria-label="nip" aria-describedby="nip" />
                            </div>

                            <label for="gol" class="mt-1">Golongan</label>
                            <div class="input-group mb-1">
                                <input type="text" class="form-control" id="gol" name="gol"
                                    placeholder="gol" aria-label="gol" aria-describedby="gol" />
                            </div>

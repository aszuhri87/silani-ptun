    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ url('admin/applicant/import') }}" id="formImport" method="post"
                    ...
                    <div class="modal-body">
                        ...
                        <a href="{{ url('admin/download_format') }}" class="mb-3 text-primary font-italic font-underline">
                            *Klik teks ini untuk download contoh format </a>
                        <p class="mb-3 text-danger font-italic"> *Import hanya bekerja dengan format excel (.xls, .xlsx),
                            pastikan isi file excel sesuai contoh format! </p>
                    </div>

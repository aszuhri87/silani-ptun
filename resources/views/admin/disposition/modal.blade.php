                    ...
                    <div class="col-md-12" >
                        <form id="form-disposition" name="form-disposition" class="auth-register-form mt-2" enctype="multipart/form-data">
                            ...
                            <div class="main">
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="text" name="agenda_number" id="agenda_number" required>
                                </div>
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="date" name="date_number" id="date_number" required>
                                </div>
                                ...
                                <div class="input-group">
                                    <textarea data-length="50" class="form-control char-textarea" id="resume_content" name="resume_content"
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="uploaded_file" id="uploaded_file" class="dropify" accept=".pdf" data-allowed-file-extensions="pdf" data-max-file-size-preview="5M">

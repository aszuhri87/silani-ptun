                        ...
                        $('div#doc_file').append(`
                            ...
                            <div class="input-group mb-1">
                                <span class="input-group-text " id="basicadd`+i+`">
                                    <a href="/admin/document/download/`+data.data.document_file[i].doc_req_id+`" style="padding-right: 5px;"> Unduh </a>
                                    <input type="hidden" name="req_value" value="`+data.data.document_file[i].requirement_value+`">

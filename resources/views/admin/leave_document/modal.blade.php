<div class="modal fade" id="input-docs-leave" tabindex="-1" role="dialog" aria-labelledby="SubUnitModalTitle"
    aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form id="form-doc-category" name="form-doc-category" class="auth-register-form mt-2">
                    <div class="col-md-12 econtent">
                        ...
                        <small class="textarea-counter-value float-right bg-success"><span class="char-count">0</span> /
                            50 </small>
                        ...
                        <div class="input-group">
                            <textarea data-length="50" class="form-control char-textarea" id="address" required name="address" rows="3"
                                placeholder=""></textarea>
                        </div>
                        <small class="textarea-counter-value float-right bg-success"><span class="char-count">0</span> /
                            50 </small>
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" name="working_time" id="working_time"
                                required>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" name="remain[0]" id="remain0"
                                        placeholder="N-1" required>
                                    <label for="amount">Keterangan</label>
                                    <input class="form-control" type="number" name="amount[0]" id="amount0"
                                        placeholder="Masih...hari" required>
                                </div>
                            </div>
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" name="remain[1]" id="remain1"
                                        placeholder="N" required>
                                    <label for="amount1">Keterangan</label>
                                    <input class="form-control" type="number" name="amount[1]" id="amount1"
                                        placeholder="Masih...hari" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <label for="address" id="address" class="form-label">Cuti di Luar Tanggungan
                            Negara</label>
...
<div class="vertical-modal-ex">
    <!-- Modal -->
    <div class="modal fade" id="modal-docs-category" tabindex="-1" role="dialog"
        aria-labelledby="SubUnitModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="SubUnitModalTitle"></h5>
                    ...
                    <div class="col-md-12">
                        <form id="form-doc-category" name="form-doc-category" class="auth-register-form mt-2">
                            <div class="col-md-12 econtent">
                                <label for="letter_head" id="letter_head" class="form-label mt-1">Kop Surat</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="letter_head" id="letter_head"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Cari Pegawai</label>
                                    <select class=" form-control" id="select-letter-edit" data-toggle="collapse"
                                        required data-target="#timeline"></select>
                            ...
                            <label for="address" id="address" class="form-label">Cuti Karena Alasan
                                Penting</label>
                            <input type="hidden" name="type[]" value="Karena Alasan Penting">
                            <input class="form-control" type="number" name="amount[]" id="amount4" required>
                                        ...
                                        <td style="padding: 10px; border: 3px solid;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div style="padding-top: 15px;">
                                                            <div
                                                                style="display: flex; padding: 0; margin: 0;  white-space:0;">
                                                                Yogyakarta, &nbsp; <p class="tanggal"
                                                                    style="padding: 0; margin: 0;  white-space:0;"></p>
                                                            </div>
                                                            <div
                                                                style="display: flex; padding: 0; margin: 0;  white-space:0;">
                                                                Kepada
                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border: 1px solid;" colspan="3">
                                                        <p class="ml-1"
                                                            style="padding: 0; margin: 0;  white-space:0;"> Pengadilan
                                                            Tata Usaha Negara Yogyakarta </p>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border: 1px solid; width: 10%;">
                                                        <p class="besar"
                                                            style="padding: 0; margin: 0;  white-space:0; text-align: center;">
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td
                                                        style="border-top: 1px solid; border-right: 1px solid; border-left: 1px solid; width: 40%; text-align:center;">
                                                        <b>Hormat Saya,</b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td
                                                        style="border-right: 1px solid; border-left: 1px solid; height: 15px;">
                                                        <p class="address ml-1"
                                                            style="padding: 0; margin: 0;  white-space:0;"></p>
                                                    </td>
                                                    <td
                                                        style="border-right: 1px solid; border-left: 1px solid; height: 15px; text-align: center;">
                                                        <p class="phone"
                                                            style="padding: 0; margin: 0;  white-space:0;"></p>
                                                    </td>
                                                    <td
                                                        style="height: 15px; border-right: 1px solid; border-left: 1px solid;">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="border-right: 1px solid; border-left: 1px solid; padding-left: 55px;"
                                                        class="user-sign">
                                                ...
                                                <tr>
                                                    ...
                                                    <td
                                                        style=" border-right: 1px solid; border-bottom: 1px solid; height: 15px;">

                                                    </td>
                                                    <td
                                                        style="text-align:center; border-right: 1px solid; border-bottom: 1px solid;">
                                                        <b
                                                            style="text-decoration: underline; padding: 0; margin: 0;  white-space:0">
                                                            <p class="name_sign"
                                                                style="padding: 0; margin: 0;  white-space:0;"></p>
                                                        </b> <b class="nip"></b>
                                                    </td>
                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td style="border-right: 1px solid; border-bottom: 1px solid; border-left: 1px solid; height: 15px;"
                                                        colspan="3">

                                                    </td>
                                                    <td
                                                        style="border-right: 1px solid; border-bottom: 1px solid; text-align:center;">
                                                        <p style="padding: 0; margin: 0;  white-space:0;"><b
                                                                style="text-decoration: underline; margin-bottom: 0; padding: 0; margin: 0;  white-space:0;"
                                                                class="atasan_name">(..................)</b> <br></p><b
                                                            style="padding: 0; margin: 0;  white-space:0;"
                                                            class="nip_atasan">
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td style="border-right: 1px solid; border-left: 1px solid; border-bottom: 1px solid; height: 15px;"
                                                        colspan="3">

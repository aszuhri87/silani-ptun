                        ...
                        <div class="card mb-0">
                            ...
                            @endif
                                ...
                                <form class="auth-forgot-password-form mt-2" action="{{ route('password.email') }}" method="POST">
                                    ...
                                    <button class="btn btn-success btn-block" tabindex="2">Kirim link reset</button>
                                </form>

                                <p class="text-center mt-2">
                                    <a href="{{ route('login') }}" class="text-success"> <i data-feather="chevron-left"></i> Kembali ke login </a>
                                </p>
                            </div>
                        </div>
                        <!-- /Forgot Password v1 -->

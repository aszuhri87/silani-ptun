                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <form class="auth-reset-password-form mt-2" action="{{ route('password.update') }}" method="POST">
                                    ...
                                    <button class="btn btn-success btn-block" tabindex="3">Set New Password</button>
                                </form>

                                <p class="text-center mt-2">
                                    <a href="{{ route('login') }}" class="text-success"> <i data-feather="chevron-left"></i> Back to login </a>
                                </p>
                            </div>
                        </div>
                        <!-- /Reset Password v1 -->

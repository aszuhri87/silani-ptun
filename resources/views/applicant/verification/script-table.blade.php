    ...
    var VerifTable = function() {
        ...
        const initTable = () => {
            init_table = $('#init-table').DataTable({
                ...
                ajax: {
                    type: 'POST',
                    url: "{{ url('applicant/verification-process/dt') }}",
                },
                columns: [
                    { data: 'DT_RowIndex' },
                    { data: 'name' },
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render : function(data, type, full, meta) {
                            ...
                            <a href="{{ url('applicant/verification/update-approval') }}/${data}" title="Edit" class="btn btn-light btn-edit btn-sm btn-clean btn-icon" title="Edit">
                            ...
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <a href="{{ url('/applicant/verification-process') }}/${data}" title="Detail" class="btn btn-light btn-detail btn-sm btn-clean btn-icon" data-toggle="tooltip">
                                    <span class="svg-icon svg-icon-md">
                ...
                rowCallback: function(row, data, index){
                            if (data.status=='Diproses') {
                                $(row).find('td:eq(5)').html('<span class="badge badge-pill badge-light-warning mr-1">'+data.status+'</span>');

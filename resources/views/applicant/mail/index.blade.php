        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Buat Surat</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="#">Perizinan Surat</a>
                                </li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                <label for="blog-edit-title">Judul</label>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                ...
                                                <select id="blog-edit-category" class="select2 form-control" multiple>
                                                    <option value="Fashion" selected>Surat Lamaran</option>
                                                    <option value="Food">Surat Magang</option>
                                                    <option value="Gaming" selected>Surat Cuti</option>
                                                    <option value="Quote">Slip Gaji</option>
                                                    <option value="Video">Proposal</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                <label for="blog-edit-slug">Perihal</label>
                                                <input type="text" id="blog-edit-slug" class="form-control" value="the-best-features-coming-to-ios-and-web-design" />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                <label for="blog-edit-slug">Nama</label>
                                                <input type="text" id="blog-edit-slug" class="form-control" value="Chad Alexander" />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                <label for="blog-edit-slug">Kepada</label>
                                                <input type="text" id="blog-edit-slug" class="form-control" value="PT. Varx" />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                <label for="blog-edit-slug">Tempat</label>
                                                <input type="text" id="blog-edit-slug" class="form-control" value="DI Yogyakarta" />
                                            </div>
                                        </div>
                                        {{-- <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">

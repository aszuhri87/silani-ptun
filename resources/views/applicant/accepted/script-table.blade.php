    ...
    var DoneTable = function() {
        ...
        const initTable = () => {
            init_table = $('#init-table').DataTable({
                ...
                ajax: {
                    type: 'POST',
                    url: "{{ url('applicant/done-docs/dt') }}",
                },
                columns: [
                    { data: 'DT_RowIndex' },
                    { data: 'name' },
                    ...
                    },
                    {
                        ...
                        render : function(data, type, full, meta) {
                            ...
                            <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="{{ url('/applicant/done-docs') }}/${data}" title="Detail" class="btn btn-light btn-edit btn-sm btn-clean btn-icon" data-toggle="tooltip">

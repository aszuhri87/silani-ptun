                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                                            ...
                                            <div class="media">
                                                <a href="javascript:void(0);" class="mr-25">
                                                    ...
                                                    @else
                                                        <img src="{{ asset('/files/profile.png') }}" id="account-upload-img"
                                                ...
                                                <form class="validate-form mt-2" id="change-profile">
                                                    <div class="media-body mt-75 ml-1">
                                                        <label for="image"
                                                            class="btn btn-sm btn-success mb-75 mr-75">Upload</label>
                                                        <input type="file" id="image" name="image" hidden
                                                            accept="image/*" max-file-size="10240000" />
                                                        <input type="hidden" id="no_image" name="no_image" value="false">
                                                        <button class="btn btn-sm btn-outline-secondary mb-75"
                                                            type="button" id="reset_photo">Reset</button>
                                                        <p>Format: JPG, JPEG atau PNG. Max ukuran 2MB</p>
                                                    </div>
                                                    <!--/ upload and reset button -->
                                            </div>
                                            <div class="row">
                                        ...
                                        <div class="tab-pane fade" id="account-vertical-password" role="tabpanel"
                                            ...
                                            <form class="validate-form" id="change-password">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <button type="submit" class="btn btn-success mr-1 mt-1">Simpan
                                                            perubahan</button>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="address" name="address" value="{{ $data->address }}" rows="4"
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <label for="gender_edit" id="description"
                                                            class="form-label">Jenis Kelamin</label>
                                                        <div class="input-group mb-2">
                                                            <div class="form-check form-check-inline custom-radio">
                                                                <input type="radio" id="gender_edit1" name="gender"
                                                                    class="form-check-input" value="Pria">
                                                                <label class="form-check-label"
                                                                    for="gender_edit1">Pria</label>
                                                            </div>
                                                            <div class="form-check form-check-inline custom-radio">
                                                                <input type="radio" id="gender_edit2" name="gender"
                                                                    class="form-check-input" value="Wanita">
                                                                <label class="form-check-label"
                                                                    for="gender_edit2">Wanita</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @if (Auth::user()->category == 'karyawan')
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="gol"
                                                                    placeholder="Golongan" value="{{ $data->gol }}"
                                                                    name="gol" />
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <a href="javascript:void(0);" class="mr-25">
                                                                    @if ($data->signature)
                                                                        <img src="{{ asset('/signature/' . $data->signature) }}"
                                                                            id="signature-upload-img"
                                                                ...
                                                                <br>
                                                                <label for="signature"
                                                                    class="btn btn-sm btn-success mb-75 mr-75 mt-2">Upload</label>

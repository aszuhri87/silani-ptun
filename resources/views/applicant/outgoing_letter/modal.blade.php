                    ...
                    <div class="col-md-12" >
                        <form id="form-outgoing" name="form-outgoing" class="auth-register-form mt-2" enctype="multipart/form-data">
                            <div class="main">
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="text" name="letter_number" id="letter_number" required>
                                </div>
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="date" name="date_letter" id="date_letter" required>
                                </div>

    ...
    <table class="table">
        ...
        <tr>
            ...
            <td valign="top" style="border-left: none;" width="20px">
                ...
                <input class="no-space" type="checkbox"
                    @foreach ($data->disposition as $d) @if ($d->role == 'Panitera Muda Hukum') style="background-color: red; border-radius: 5px; color: white; " @endif @endforeach>
                <input class="no-space" type="checkbox"
                    @foreach ($data->disposition as $d) @if ($d->role == 'Panitera Muda Perkara') style="background-color: red; border-radius: 5px; color: white; " @endif @endforeach>
                <input class="no-space" type="checkbox"
                    @foreach ($data->disposition as $d) @if ($d->role == 'Kasub Umum dan Keuangan') style="background-color: red; border-radius: 5px; color: white; " @endif @endforeach>
                <input type="checkbox" style="padding-top: 18px;"
                    @foreach ($data->disposition as $d) @if ($d->role == 'Kasub Kepegawaian, Ortala') style="background-color: red; border-radius: 5px; color: white; " @endif @endforeach>

                                ...
                                <div class="forward-form">
                                    ...
                                    <div class="form-group">
                                        <select class=" form-control" id="select-fordward" data-toggle="collapse"
                                            required data-target="#timeline" name="role" required>
                                            ...
                                            @elseif (Auth::user()->title == 'Sekretaris')
                                                ...
                                                <option value="Kasub Kepegawaian, Ortala">Kasub Kepegawaian, Ortala
                                                </option>
                                                <option value="Kasub Perencanaan, TI dan Pelaporan">Kasub Perencanaan,
                                                    TI dan Pelaporan</option>
                                            @endif
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="modal-body ">
                                ...
                                <form id="print">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td valign="top" colspan="2" height="100px"
                                                    ...
                                                    <div style="display: flex;">
                                                        <h5 class="no-space" style="width: 170px;">DISPOSISI PANMUD
                                                        </h5>
                                                    ...
                                                    <br>
                                                    <div style="display: flex;">
                                                        <h5 class="no-space" style="width: 170px;">DISPOSISI KASUBAG
                                                        </h5>
                                                        <h5 class="no-space" style="float: left;">: </h5>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        ...
                                        <label for="requirement_value" class="mt-2">Dokumen/File Upload Manual:
                                        </label>

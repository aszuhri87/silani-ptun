    ...
    var DocsCategoryTable = function() {
        ...
        const initTable = () => {
            init_table = $('#init-table').DataTable({
                ...
                ajax: {
                    type: 'POST',
                    url: "{{ url('applicant/leave-document/dt') }}",
                },
                columns: [
                    { data: 'DT_RowIndex' },
                    { data: 'name' },
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render : function(data, type, full, meta) {
                            ...
                            <a href="{{ url('applicant/leave-document') }}/${data}" title="Edit" class="btn btn-light btn-edit btn-sm btn-clean btn-icon" title="Edit">
                                    ...
                                    <a href="{{ url('applicant/leave-document') }}/${data}" title="Detail" class="btn btn-light btn-detail btn-sm btn-clean btn-icon" data-toggle="tooltip">
                                        <span class="svg-icon svg-icon-md">
                                    ...
                                    <a href="{{ url('applicant/leave-document') }}/${data}" title="Delete" class="btn btn-light btn-delete btn-sm btn-clean btn-icon" title="Delete">
                                        <span class="svg-icon svg-icon-md">
